 ...
 */
declare class PartialMerkleTree {
 ...
 */
declare var mnList: SimplifiedMNListEntry[];

/**
 * This property contains only valid, not PoSe-banned nodes.
 * @type {SimplifiedMNListEntry[]}
 */
declare var validMNs: SimplifiedMNListEntry[];
 ...
 */
declare class SimplifiedMNListDiff {
 ...
 * @property {boolean} isValid
 */
declare class SimplifiedMNListEntry {
 ...
 * @class bitcore
 */
declare class bitcore {
}

declare namespace bitcore {
    /**
     * @constructor
     */
    class Error {
 ...
 */
declare type CoinbasePayloadJSON = {
    version: number;
    height: number;
    merkleRootMNList: string;
 ...
 */
declare type CommitmentTxPayloadJSON = {
    version: number;
    height: number;
    qfcVersion: number;
    llmqtype: number;
 ...
 * @property {string} sig
 */
declare class CommitmentTxPayload {
    /**
     * Parse raw payload
     * @param {Buffer} rawPayload
 ...
 * @return {AbstractPayload}
 */
declare function getPayloadClass(payloadType: number): AbstractPayload;
 ...
 * @return {AbstractPayload}
 */
declare function parsePayloadBuffer(payloadType: number, rawPayload: Buffer): AbstractPayload;
 ...
 * @return {AbstractPayload}
 */
declare function parsePayloadJSON(payloadType: number, payloadJson: any): AbstractPayload;
 ...
 * @return {AbstractPayload}
 */
declare function createPayload(payloadType: any): AbstractPayload;
 ...
 * @return {boolean}
 */
declare function isPayloadMatchesType(payloadType: number, payload: AbstractPayload): boolean;
 ...
 * @return {Buffer}
 */
declare function serializePayloadToBuffer(payload: AbstractPayload): Buffer;
 ...
 * @return {Object}
 */
declare function serializePayloadToJSON(payload: any): any;
 ...
 */
declare type ProRegTxPayloadJSON = {
    version: number;
 ...
 */
declare type ProUpRegTransactionPayloadJSON = {
    version: number;
    proTxHash: string;
    pubKeyOperator: string;
    keyIDVoting: string;
 ...
 * @constructor
 */
declare class ProUpRegTxPayload {
 ...
 * @property {string} payloadSig
 */
declare type ProUpRevTransactionPayloadJSON = {
    version: number;
    proTxHash: string;
    reason: number;
    inputsHash: string;
 ...
 */
declare class ProUpRevTxPayload {
    /**
 ...
 * @property {string} [payloadSig]
 */
declare type ProUpServTxPayloadJSON = {
    version: number;
    proTxHash: string;
    service: string;
 ...
 */
declare class ProUpServTxPayload {
    /**
     * Parse raw transition payload
     * @param {Buffer} rawPayload
 ...
 */
declare type SubTxCloseAccountPayloadJSON = {
    version: number;
    regTxHash: string;
 ...
 * @property {string} payloadSig - Signature from either the current key or a previous key (<= ~90 days old)
 */
declare class SubTxCloseAccountPayload {
    /**
     * Parse raw transition payload
     * @param {Buffer} rawPayload
 ...
 */
declare type BlockchainUserPayloadJSON = {
    version: number;
    pubKeyId: Buffer;
    userName: string;
    payloadSig?: string;
 ...
 * @property {string} [payloadSigSize]
 */
declare class SubTxRegisterPayload {
    /**
 ...
 */
declare type SubTxResetKeyPayloadJSON = {
    version: number;
    regTxHash: string;
    hashPrevSubTx: string;
    creditFee: number;
 ...
 * @property {string} payloadSig - signature of most recent pubkey
 */
declare class SubTxResetKeyPayload {
    /**
     * Parse raw transition payload
     * @param {Buffer} rawPayload
 ...
 * @property {string} regTxHash
 */
declare type SubTxTopupPayloadJSON = {
    version: number;
    regTxHash: string;
};
 ...
 * @property {string} regTxHash
 */
declare class SubTxTopupPayload {
    /**
     * Parse raw transition payload
     * @param {Buffer} rawPayload
 ...
 * @property {string} [payloadSigSize]
 */
declare type TransitionPayloadJSON = {
    version: number;
    regTxId: string;
    hashPrevSubTx: string;
    creditFee: number;
 ...
 * @property {string} [payloadSigSize]
 */
declare class SubTxTransitionPayload {
    /**
 ...
 * @return {boolean}
 */
declare function isBitString(bitString: string): boolean;
 ...
 * @return {number[]}
 */
declare function convertBitArrayToUInt8Array(bitArray: boolean[] | number[], reverseBits?: boolean): number[];
 ...
 * @return {number[]}
 */
declare function bitStringToUInt8Array(bitString: string, reverseBits: boolean): number[];
 ...
 * @return {Buffer}
 */
declare function ipAndPortToBuffer(string: string): Buffer;
 ...
 * @return {string}
 */
declare function bufferToIPAndPort(buffer: Buffer): string;
 ...
 * @return {boolean}
 */
declare function isIpV4(ipAndPortString: string): boolean;
 ...
 */
declare function getMerkleTree(hashes: Buffer[]): Buffer[];
 ...
 */
declare function getMerkleRoot(merkleTree: Buffer[]): Buffer | undefined;
 ...
 * @return {number}
 */
declare function calculateTreeWidth(totalElementsCount: number, height: number): number;

/**
 * @param {number} hashesCount
 * @return {number}
 */
declare function calculateTreeHeight(hashesCount: number): number;
 ...
 * @return {Buffer}
 */
declare function calculateHashAtHeight(height: number, position: number, hashes: Buffer[]): Buffer;
 ...
 */
declare function traverseAndBuildPartialTree(height: number, position: number, hashes: Buffer[], matches: boolean[]): any;
